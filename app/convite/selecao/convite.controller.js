(function () {
  ...
  ConviteController.$inject = ['serverService', 'conversorService', 'session', '$http', '$filter'];

  function ConviteController(serverService, conversorService, session, $http, $filter) {
