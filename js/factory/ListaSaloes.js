angular.module("dashboard").factory('ListaSaloes', ['CallAjax', '$q', function (CallAjax, $q) {
  var getData = function (id) {
    var urlVar = "http://23.238.16.114/celebri_dev/ServiceCasamento.svc/RetornarConfiguracaoListaSaloes";
  ...
  var remove = function (id, dataId) {
    var urlVar = "http://23.238.16.114/celebri_dev/ServiceCasamento.svc/ExcluirSaloes";
  ...
  var setData = function (xmlVar) {
    var urlVar = "http://23.238.16.114/celebri_dev/ServiceCasamento.svc/ConfigAdicionalEvento_ListaSaloes";
    var call = CallAjax.resposta(urlVar, xmlVar);
    var deferred = $q.defer();
