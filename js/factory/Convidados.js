angular.module("dashboard").factory('Convidados', ['CallAjax', '$q', function (CallAjax, $q) {
  var getData = function (id) {
    var urlVar = "http://23.238.16.114/celebri_dev/ServiceCasamento.svc/RetornarConvidados";
  ...
  var remove = function (id, dataId) {
    var urlVar = "http://23.238.16.114/celebri_dev/ServiceCasamento.svc/ExcluirConvidados";
  ...
  var setData = function (xmlVar) {
    var urlVar = "http://23.238.16.114/celebri_dev/ServiceCasamento.svc/CadastroConvidados";
    var call = CallAjax.resposta(urlVar, xmlVar);
    var deferred = $q.defer();
