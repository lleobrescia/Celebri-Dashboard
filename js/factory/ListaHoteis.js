angular.module("dashboard").factory('ListaHoteis', ['CallAjax', '$q', function (CallAjax, $q) {
  var getData = function (id) {
    var urlVar = "http://23.238.16.114/celebri_dev/ServiceCasamento.svc/RetornarConfiguracaoListaHoteis";
  ...
  var remove = function (id, dataId) {
    var urlVar = "http://23.238.16.114/celebri_dev/ServiceCasamento.svc/ExcluirHoteis";
  ...
  var setData = function (xmlVar) {
    var urlVar = "http://23.238.16.114/celebri_dev/ServiceCasamento.svc/ConfigAdicionalEvento_ListaHoteis";
    var call = CallAjax.resposta(urlVar, xmlVar);
    var deferred = $q.defer();
