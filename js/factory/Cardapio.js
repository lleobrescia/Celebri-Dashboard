angular.module("dashboard").factory('Cardapio', ['CallAjax', '$q', function (CallAjax, $q) {
  ...
  var getData = function (id) {
    var urlVar = "http://23.238.16.114/celebri_dev/ServiceCasamento.svc/RetornarCardapio";
  ...
  var remove = function (id, dataId) {
    var urlVar = "http://23.238.16.114/celebri_dev/ServiceCasamento.svc/ExcluirCardapio";
  ...
  var setData = function (xmlVar) {
    var urlVar = "http://23.238.16.114/celebri_dev/ServiceCasamento.svc/CadastrarCardapio";
    var call = CallAjax.resposta(urlVar, xmlVar);
    var deferred = $q.defer();
